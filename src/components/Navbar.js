...
export default function Navbar({ page }) {
  ...
  return (
    <header
      className="bg-gradient-to-b from-gray-500  to-white px-5"
    ...
    >
      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <Link
            ...
            style={{ color: page == "home" ? "#fb0400" : "white" }}
          >
            Home
          </Link>
          {/* <Link
      ...
      >
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-gradient-to-r from-gray-500 to-black px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-red-800">
              <div className="space-y-2 py-6 text-white">
                ...
                <Link
                  to="/"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-my-color"
                >
                  Home
                </Link>
                {/* <Link
